...
from Muskan_Music.helpers._store import get_assistant, get_authuser_names, get_cmode
from Muskan_Music.helpers.wrap import ActualAdminCB, AdminActual, language
from Muskan_Music.helpers._fmt import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Muskan.stop_stream_force(chat_id)
        except:
            pass
