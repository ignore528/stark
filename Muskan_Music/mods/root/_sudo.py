...
from Muskan_Music.helpers._store import add_sudo, remove_sudo
from Muskan_Music.helpers.wrap._lang import language
from Muskan_Music.helpers._ext import extract_user
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("❍ sᴛᴀᴋʀ ᴋᴀ ʟᴜɴᴅ ᴅᴇᴋʜᴇɢᴀ ᴀᴘɴɪ ʙᴇʜᴀɴ ᴋᴏ ᴅᴇ ᴅᴇɴᴀ 🤪 ●", show_alert=True)
    else:
